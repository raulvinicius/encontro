...
<!--<![endif]-->
    ...
    <head>
        ...
        <title><?php echo ( $post->post_name != '' ) ? get_the_title() . " | " : ""; ?>Encontro da Vinci</title>
                ...
                <nav>
                    <ul>
                        <li class="atual">
                            <span>
                                <svg version="1.1"
                                     ...
                                     x="0px" y="0px" width="6px" height="6px" viewBox="0 0 45.8 45.8" style="enable-background:new 0 0 45.8 45.8;"
                                     xml:space="preserve">
                        ...
                        <li>
                            ...
                            <a class="ani-02" href="#voce-e-show">Você é Show</a>
                        </li>
                        <li>
                            <span>
                                <svg version="1.1"
                            ...
                            <a class="ani-02" href="#atracoes">Atrações</a>
                        </li>
                        <li>
                            <span>
                                <svg version="1.1"
                            ...
                            <a class="ani-02" href="#inscricao">Inscrições</a>
                        </li>
                    </ul>
